...
public class BasicSymmetricTransformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_symmetric_transformation);
...
//                    params.width*=3;
                    ...
                    MotionAnimationUtils.expandAsymmetric(cardView, 3f, 3f, 320, 0);
                } else {
                    MotionAnimationUtils.contractAsymmetric(cardView, 0.33f, 0.33f, 320, 0);
//                    params.height/=3;
//                    params.width/=3;
                }
